    ...
    <section id="new" class="w-100">
        <div class="row p-0 m-0">
            ...
            <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
                ...
                <div class="details">
                    <h2>Manga Library</h2>
                    <a href="library.php"><button class="text-uppercase">Library</button></a>
                </div>
            </div>
            ...
            <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
                ...
                <div class="details">
                    ...
                    <a href="category.php"><button class="text-uppercase">Category</button></a>
                </div>
            </div>
            <!-- item3 -->
            <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
                ...
                <div class="details">
                    ...
                    <a href="comments.php"><button class="text-uppercase">Comments</button>
                </div>
            </div>
        </div>
    </section>
